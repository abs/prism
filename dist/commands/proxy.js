...
const proxyCommand = {
    ...
    handler: async (parsedArgs) => {
        ...
        const p = (0, lodash_1.pick)(parsedArgs, 'dynamic', 'explicit', 'cors', 'host', 'port', 'document', 'multiprocess', 'upstream', 'errors', 'validateRequest', 'verboseLevel', 'ignoreExamples', 'upstreamProxy', 'jsonSchemaFakerFillProperties');
